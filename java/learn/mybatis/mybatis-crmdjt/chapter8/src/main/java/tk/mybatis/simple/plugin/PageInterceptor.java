...
public class PageInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (!dialect.skip(ms.getId(), parameterObject, rowBounds)) {
            ...
            Map<String, Object> addtionalParameters = (Map<String, Object>) additionalParametersField.get(boundSql);
            ...
            if (dialect.beforeCount(ms.getId(), parameterObject, rowBounds)) {
                ...
                for (String key : addtionalParameters.keySet()) {
                    countBoundSql.setAdditionalParameter(key, addtionalParameters.get(key));
                }
            ...
            if (dialect.beforePage(ms.getId(), parameterObject, rowBounds)) {
                ...
                for (String key : addtionalParameters.keySet()) {
                    pageBoundSql.setAdditionalParameter(key, addtionalParameters.get(key));
                }
